...
protocol MapViewControllerDelegate { //@objc
    func getAddress(_ address: String?) //@objc optional
}
...
class MapViewController: UIViewController {
    ...
    private func getDirections() {
        ...
        directions.calculate { (response, error) in
            ...
            guard let response = response else {
                self.showAlert(title: "Error", message: "Direction isn't available")
                return
            }
    ...
    private func createDirectionsRequest(from coordinate: CLLocationCoordinate2D) -> MKDirections.Request? {
        ...
        request.requestsAlternateRoutes = true // few
    ...
    private func checkLocationServeces() {
